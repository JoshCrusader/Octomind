...
def room_details_analysis(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST['report_cat'] == "range":
            ...
            print("what")
    return render(request, 'octo_site/reports/details/room_details_analysis.html',{"report_data":report_data,"msg":msg,"games":games,"room":room,"id_slugs": game_ids,"records_len":len(games), "rep_cat": request.POST['report_cat'], "date" : a_date, "sd": a_sd, "ed": a_ed})
