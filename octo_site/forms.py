...
class RoomForm(forms.ModelForm):
    ...
    room_name = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'class' : 'uk-input uk-display-inline','placeholder':'Enter a name for the sensor','autocomplete':"false"}))
